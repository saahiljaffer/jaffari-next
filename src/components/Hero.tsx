...
export const MyHero = () => {
  return (
    <Hero className="flex-auto bg-secondary py-6 text-secondary-content">
        ...
        <div className="flex flex-col gap-4">
          <div className="flex flex-col gap-2">
            ...
            <p>
              ...
              Community Centre is a 100,000 square foot facility that is home to
              a variety of community programs and services.
            </p>
          </div>
